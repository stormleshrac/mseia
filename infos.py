...
def dashboard():
    start_msg = '<a href="https://t.me/vipup_techdev_v2_bot">VipUp v2</a>\n'
    start_msg += '<b>Envia Enlaces De Descarga y Archivos Para Procesar</b>\n'
    return start_msg
...
def createDownloading(filename,totalBits,currentBits,speed,time,tid=''):
    ...
    msg += '➤ Actual: ' + sizeof_fmt(currentBits)+'/'+ sizeof_fmt(totalBits) + '\n\n'
